    ...
    return (
      <div
        ...
        className={cn(
          ...
          // Variant styles
          {
            'bg-primary-50 border-primary-200 text-primary-800': variant === 'info',
            ...
            'bg-error-50 border-error-200 text-error-800': variant === 'error',
          },
      ...
      >
        <div className="flex gap-3">
          ...
          {dismissible && (
            <button
              onClick={onDismiss}
              className="flex-shrink-0 ml-2 -mt-1 -mr-1 p-1 rounded hover:bg-black/5 transition-colors"
  ...
  ({
    ...
    return (
      <div
        ref={ref}
        className={cn(
          'pointer-events-auto w-full max-w-sm rounded-lg shadow-lg ring-1 ring-black ring-opacity-5',
          'animate-slide-up',
          
          // Variant styles
          {
            'bg-white ring-primary-200': variant === 'info',
            'bg-white ring-success-200': variant === 'success', 
            'bg-white ring-warning-200': variant === 'warning',
            'bg-white ring-error-200': variant === 'error',
          },
